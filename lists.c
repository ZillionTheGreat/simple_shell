...
/**
 * delete_node_at_index - deletes node at any given index
 * @head: the address of the pointer to the first node
 * @index: the index of nodes to delete
 *
 * Return: 1 on success, 0 otherwise or on failure
 */
...
/**
 * free_list - frees all of the nodes of a list
